...
# ╔═╡ 5fd31476-599e-4cd5-9697-630c4fb0f438
arte_de_pixeles = [RGB(0, 0, 0)  RGB(1, 1, 1)  RGB(1, 1, 1)  RGB(1, 1, 1)  RGB(1, 0.84, 0)  RGB(0, 0, 0)  RGB(1, 1, 1)  RGB(1, 1, 1)
 RGB(1, 0.84, 0)  RGB(1, 0.84, 0)  RGB(1, 0.84, 0)  RGB(1, 0.84, 0)  RGB(1, 0.84, 0)  RGB(1, 1, 1)  RGB(1, 1, 1)  RGB(1, 1, 1)
 RGB(0, 0, 0)  RGB(1, 0.84, 0)  RGB(0, 0, 0)  RGB(1, 0.84, 0)  RGB(0.93, 0.79, 0.0)  RGB(1, 1, 1)  RGB(1, 1, 1)  RGB(1, 0.84, 0)
 RGB(1, 0.84, 0)  RGB(0, 0, 0)  RGB(1, 0.84, 0)  RGB(1, 0.84, 0)  RGB(0.93, 0.79, 0.0)  RGB(1, 1, 1)  RGB(1, 0.84, 0)  RGB(1, 0.84, 0)
 RGB(1, 1, 1)  RGB(1, 0.84, 0)  RGB(1, 0.84, 0)  RGB(0.55, 0.3, 0.22)  RGB(0.55, 0.3, 0.22)  RGB(1, 1, 1)  RGB(1, 0.84, 0)  RGB(0.8, 0.68, 0.0)
 RGB(0.8, 0.68, 0.0)  RGB(1, 0.84, 0)  RGB(0.8, 0.68, 0.0)  RGB(1, 0.84, 0)  RGB(0.93, 0.79, 0.0)  RGB(1, 1, 1)  RGB(1, 0.84, 0)  RGB(0.8, 0.68, 0.0)
 RGB(1, 1, 1)  RGB(1, 0.84, 0)  RGB(1, 0.84, 0)  RGB(0.55, 0.3, 0.22)  RGB(0.55, 0.3, 0.22)  RGB(1, 0.84, 0)  RGB(0.8, 0.68, 0.0)  RGB(1, 1, 1)
 RGB(0.8, 0.68, 0.0)  RGB(1, 0.84, 0)  RGB(0.8, 0.68, 0.0)  RGB(1, 0.84, 0)  RGB(0.93, 0.79, 0.0)  RGB(1, 1, 1)  RGB(1, 1, 1)  RGB(1, 1, 1)]
...
# ╔═╡ 6c690561-e413-4ecb-a1a2-a022288709fb
save("nariz.png",nariz)

# ╔═╡ c9ac7f3e-0448-4698-b875-a32244afcd76
save("Pikachu.png",arte_de_pixeles)
